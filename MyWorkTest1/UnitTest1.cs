...
namespace MyWorkTest
{
    ...
    public class Form1Tests
    {
        ...
        /// <summary>
        /// Tests the DrawCircle method with a invalid circle radius.
        /// </summary>
        [Test]
...
public void TestTriangle_ValidCommand()
{
    ...
    form.ExecuteCommand($"Triangle {side1} {side2}");
        ...
        /// <summary>
        /// Tests the color method with the coloe "red".
        /// </summary>
        [Test]
public void TestSetColor_Red()
{
    ...
    form.ExecuteCommand("red");
        ...
        /// <summary>
        /// Tests the color method with the coloe "green".
        /// </summary>
        [Test]
public void TestSetColor_Green()
{
    ...
    form.ExecuteCommand("green");
        ...
        /// <summary>
        /// Tests the color method with the coloe "blue".
        /// </summary>
        [Test]
public void TestSetColor_Blue()
{
    ...
    form.ExecuteCommand("blue");
        ...
        /// <summary>
        /// Tests the behavior of the SetFillShapes method when turning fill shapes on.
        /// </summary>
        [Test]
public void TestSetFillShapes_On()
{
    ...
    form.ExecuteCommand("fill on");
        ...
        /// <summary>
        /// Tests the behavior of the SetFillShapes method when turning fill shapes off.
        /// </summary>
        [Test]
